...
**要求**：
- 所有技术债务**必须**记录在 `docs/Conventions/技术债务.md`
- 使用标准的技术债务编号（TD-XXX-NNN）
- 包含位置、描述、影响、解决方案、优先级
...
**验证点**：
- [ ] 技术债务文档存在且最新
- [ ] 所有 TODO/FIXME/HACK 都已记录
- [ ] 新增债务已分配编号
- [ ] 债务包含完整信息

### 规则 15.3：PR 前必读技术债务文档

**要求**：
- **每个 PR 提交前**必须通读 `docs/Conventions/技术债务.md`
- PR 描述中必须说明技术债务变更情况
- 新增技术债务必须在 PR 中说明原因
...
**要求**：
- 提交 PR 前**必须**解决所有**高优先级**技术债务
- 如无法解决，必须在 PR 中明确说明原因
- 需要人工审核批准
...
### 技术债务
- [ ] ✅ **已通读** docs/Conventions/技术债务.md
- [ ] 已运行 ./scripts/detect-shadow-clones.sh （增强版 v2.0 - 7类检测）
- [ ] 没有引入新的影分身代码（7类：枚举/接口/DTO/Options/扩展方法/静态类/常量）
- [ ] 新增技术债务已记录到文档
- [ ] 高优先级技术债务已全部解决或有说明
- [ ] PR 描述包含技术债务变更说明
...
- [docs/Conventions/技术债务.md](../docs/Conventions/技术债务.md) - **技术债务管理（必读）**
